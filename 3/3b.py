i = """....................................18..........889.270.....748.280...997.................617..............622........763............476....
...
class PartNumber:
    ...
    def __repr__(self):
        return f"[{self.n}, {self.coordinates}]"

    def __hash__(self):
        return hash(frozenset(self.coordinates))
    
    def __eq__(self, o):
        return all(c in o.coordinates for c in self.coordinates)


# Get all part numbers from the input
# matrix
part_numbers = []
symbols = []

for y, l in enumerate(i.split("\n")):
    x = 0
    n = []
    coordinates = set()
    for c in l:
        if c in "0123456789":
            ...
            if len(n) > 0:
                number = int("".join(n))
                part_numbers.append(PartNumber(number, coordinates))
                n = []
                coordinates = set()
    ...
    # Handle any numbers that are at the end of the line
    if len(n) > 0:
        number = int("".join(n))
        part_numbers.append(PartNumber(number, coordinates))
        n = []
...
total = 0
for symbol_coordinate in symbols:
    adjacent_parts = []
    for pn in part_numbers:
        if any(adjacent(symbol_coordinate, c) for c in pn.coordinates):
            adjacent_parts.append(pn)

    if len(adjacent_parts) != 2:
        continue

    gear_ratio = adjacent_parts[0].n * adjacent_parts[1].n
    total += gear_ratio
